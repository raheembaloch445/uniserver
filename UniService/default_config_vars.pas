...
Var
 ...
 UENV_PHP_SELECT      :string;  // PHP_SELECT     PHP Selected php70, php71, php72, php73, php74, php80, php81, php82, php83 or php85 environment var
...
begin
 ...
 //=== Unicontroller user configuration us_user.ini
   ...
   //*** Start ***
   //[USER]
   UENV_PHP_SELECT      := Ini2.ReadString('USER','PHP_SELECT','php83');                   // Version selected by user
